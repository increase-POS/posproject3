...
namespace AdministratorApp.ApiClasses
{
    ...
    public class AgentCustomer
    {
        ...
        public async Task<int> Save(AgentCustomer obj)
        {
            Dictionary<string, string> parameters = new Dictionary<string, string>();
        ...
        public async Task<int> Delete(int agentCustomerId)
        {
            Dictionary<string, string> parameters = new Dictionary<string, string>();
            parameters.Add("agentCustomerId", agentCustomerId.ToString());
            //parameters.Add("userId", userId.ToString());
        ...
        public async Task<int> saveNewList(List<AgentCustomer> newList, int agentId)
        {
